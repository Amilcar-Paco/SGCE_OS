...
<div class="span12" style="margin-left: 0">
    <form method="get" action="<?php echo base_url(); ?>index.php/os/gerenciar">
        ...
        <div class="span3">
            <a href="<?php echo base_url(); ?>index.php/os/adicionar" class="btn btn-success span12"><i class="icon-plus icon-white"></i> Adicionar Ordem de Serviço</a>
        </div>
        <?php 
    } ?>
        ...
        <table class="table table-bordered ">
            ...
            <tbody>
                ...
                default:
                    ...
                    echo '<td>MZN ' . number_format($r->valorTotal, 2, ',', '.') . '</td>';
