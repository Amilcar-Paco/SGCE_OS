                    ...
                    <?php if ($produtos != null) {?>
                        ...
                        <table class="table table-bordered table-condensed" id="tblProdutos">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($produtos as $p) {
                                            ...
                                            echo '<td>MZN '.number_format($p->subTotal, 2, ',', '.').'</td>';
                                            echo '</tr>';
                                        }?>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>MZN <?php echo number_format($totalProdutos, 2, ',', '.');?></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php }?>
                            ...
                            <table class="table table-bordered table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($servicos as $s) {
                                            ...
                                            echo '<tr>';
                                            echo '<td>'.$s->nome.'</td>';
                                            echo '<td>MZN '.number_format($s->preco, 2, ',', '.').'</td>';
                                            echo '</tr>';
                                        }?>

                                        <tr>
                                            <td colspan="1" style="text-align: right"><strong>Total:</strong></td>
                                            <td><strong>MZN <?php  echo number_format($totalServico, 2, ',', '.');?></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                        <?php }?>
                        <?php
                            if($result->status == "Finalizado" || $result->status == "Orçamento"){
                                echo "<h4 style='text-align: right'>Valor Total: MZN". number_format($totalProdutos + $totalServico, 2, ',', '.')."</h4>";
                            }
