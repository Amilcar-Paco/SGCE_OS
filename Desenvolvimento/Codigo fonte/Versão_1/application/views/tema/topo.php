...
<head>
    <title> Mechanical Tecnologia</title>
    <meta charset="UTF-8" />
...
<body>
    <!--Header-part-->
    <div id="header">
      <img style="margin-left: 60px;  width: 4.5%;" src="<?php echo base_url(); ?>assets/img/logo.png" alt="">
    </div>
    <!--close-Header-part-->
    <!--top-Header-menu-->
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav">
            ...
            <li class="pull-right"><a href="#" ><i class="icon icon-asterisk"></i> <span class="text">Versão:
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="<?php echo base_url() ?>" title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a>
    ...
    <!--Footer-part-->
    <div class="row-fluid">
        <div id="footer" class="span12"> <a href="#" >
                <?php echo date('Y'); ?> &copy; Sistema de Controle de Ordem de Serviço - Amílcar Paco </a></div>
    </div>
    <!--end-Footer-part-->
