...
<html lang="pt-br">
<head>
        <title>Mechanical Tecnologia</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/mapos/verificarLogin">
                  ...
                  <?php }?>
                <div class="control-group normal_text"> <h3><img width="15%"  src="<?php echo base_url()?>assets/img/logo.png" alt="Logo" /></h3></div>
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h4 id="myModalLabel">Sistema de Controle de Ordem de Serviço</h4>
          </div>
