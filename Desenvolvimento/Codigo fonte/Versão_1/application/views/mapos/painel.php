...
<div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <li class="bg_lo">
                <a href="<?= base_url() ?>index.php/os"> <i class="icon-tags"></i> Ordem de Serviço</a>
            </li>
            <?php endif ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <?php if($o->dataFinal != null){echo date('d/m/Y', strtotime($o->dataFinal));}else{echo "";}?>
                            </td>
                            <td>
                                <?= $o->nomeCliente ?>
                            </td>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <ul class="site-stats">
                            ...
                            <li class="bg_lh"><i class="icon-barcode"></i> <strong>
                                    <?= $this->db->count_all('produtos'); ?></strong> <small>Produtos </small></li>
                            <li class="bg_lh"><i class="icon-tags"></i> <strong>
                                    <?= $this->db->count_all('os'); ?></strong> <small>Ordens de Serviço</small></li>
                            <li class="bg_lh"><i class="icon-wrench"></i> <strong>
