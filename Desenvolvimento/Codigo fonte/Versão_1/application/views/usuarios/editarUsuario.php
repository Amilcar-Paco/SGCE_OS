        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="rg" class="control-label">B.I.<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="cpf" class="control-label">NUIT<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="numero" class="control-label">Caso Numero<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="cidade" class="control-label">Pronvíncia<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="estado" class="control-label">Nacionalidade<span class="required">*</span></label>
                        <div class="controls">
