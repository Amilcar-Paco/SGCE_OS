...
<head>
    <meta charset="utf-8">
    <title>OS - Área do Cliente</title>
...
<body>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    ...
                    <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                        ...
                        <div class="control-group">
                                <label for="documento" class="control-label">Senha<span class="required">*</span></label>
                                    <div class="controls">                                        
                        ...
                        <div class="control-group" class="control-label">
                            <label for="cep" class="control-label">B.I.<span class="required">*</span></label>
                            <div class="controls">
    ...
    <div class="row-fluid">
        <div id="footer" class="span12">
            <?= date('Y') ?> &copy; Amílcar Carlos Paco</div>
    </div>
