                        ...
                        <div class="widget-content">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="text-align: right"><strong>Casa Número</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="text-align: right"><strong>Província</strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="text-align: right"><strong>Quarteirão</strong></td>
                                        <td>
                                            <?php echo $result->cep ?>
                                        </td>
                                    </tr>
